  ...
  return (
    <div className='bg-red-400 h-screen snap-start text-5xl font-bold text-center'>
      ...
      {tabsContent.map((tabItem,index)=>(
        <div key={index} onClick={()=>handelOnClick(index)} className={`${currentTabIndex === index ? "bg-green-400" : "bg-yellow-200"} p-4 rounded-xl hover:cursor-pointer border-2 border-transparent hover:border-black`}>
